 ...
 * - `{{*}}` `put({string} key, {*} value)` вЂ” Puts a new key-value pair into the cache and returns it.
 ...
 *
 * - `always(callback)` вЂ“ allows you to observe either the fulfillment or rejection of a promise,
...
function $RouteProvider(){
   ...
   *    - `template` вЂ“ `{string=|function()=}` вЂ“ html template as a string or function that returns
